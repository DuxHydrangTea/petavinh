...
import 'package:petavinh/views/screen_create_group.dart';
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                Get.to(const ScreenCreateGroup());
                              },
                              child: Text(
                                "Create",
                                style: TextStyle(
                        ...
                        child: TabBarView(
                          children: [
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        TextButton(
                                          onPressed: () {
                                            controller.requestAction(group.id);
                                          },
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                Group group =
                                    controller.getListGrJoined()[index];
                                return GestureDetector(
                                  onTap: () {
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                Group group =
                                    controller.getManageGroup()[index];
                                return GestureDetector(
                                  onTap: () {
                                    Get.to(ScreenInsideGroup(
                                      groupId: group.id,
